...
public class EvaluationInfos {
	...
	public String getCSV() {
		return results.size() + ";" + totalVictories + ";" + avgVictories + ";" + totalDeaths + ";" + avgDeaths + ";"
				+ totalScore + ";" + avgScore + ";" + totalTimeSpent + ";" + avgTimeSpent;
	}

	@Override
	public String toString() {
		return "EvaluationInfos[RUNS=" + results.size() + ", AVGS: WIN=" + avgVictories + ", DEATH=" + avgDeaths
				+ ", SCORE=" + avgScore + ", TIME=" + avgTimeSpent + "]";
	}
