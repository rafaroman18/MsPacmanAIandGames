...
public class PacManRunsGenerator {
	...
	public static PacManConfig[] generateConfigs(int randomSeed, SimulatorConfig prototypeOptions, int runCount,
			int oneRunRepetitions) {
	...
	public static PacManRuns generateRuns(int randomSeed, SimulatorConfig prototypeOptions, int runCount,
			int oneRunRepetitions) {
		PacManConfig[] configs = generateConfigs(randomSeed, prototypeOptions, runCount, oneRunRepetitions);
