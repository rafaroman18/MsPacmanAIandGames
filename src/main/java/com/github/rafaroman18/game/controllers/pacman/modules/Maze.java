package com.github.rafaroman18.game.controllers.pacman.modules;
...
public class Maze {
	...
	public static enum NodeType {
		...
		// TURNS
		TURN_UP_RIGHT(NodeCategory.TURN), TURN_RIGHT_DOWN(NodeCategory.TURN), TURN_DOWN_LEFT(NodeCategory.TURN),
		TURN_LEFT_UP(NodeCategory.TURN),

		// CORRIDOR
		CORRIDOR_LEFT_RIGHT(NodeCategory.CORRIDOR), CORRIDOR_UP_DOWN(NodeCategory.CORRIDOR),

		// T_CROSS JUNCTIONS
		T_URD(NodeCategory.T_CROSS), T_RDL(NodeCategory.T_CROSS), T_DLU(NodeCategory.T_CROSS),
	...
	public class MazeNode {
		...
		public NodeType nodeType() {
			...
			if (neighbours[0] != null && neighbours[1] != null && neighbours[2] != null && neighbours[3] != null)
				return nodeType = NodeType.CROSS;
			if (neighbours[0] != null && neighbours[1] != null && neighbours[2] != null && neighbours[3] == null)
				return nodeType = NodeType.T_URD;
			if (neighbours[0] == null && neighbours[1] != null && neighbours[2] != null && neighbours[3] != null)
				return nodeType = NodeType.T_RDL;
			if (neighbours[0] != null && neighbours[1] == null && neighbours[2] != null && neighbours[3] != null)
				return nodeType = NodeType.T_DLU;
			if (neighbours[0] != null && neighbours[1] != null && neighbours[2] == null && neighbours[3] != null)
				return nodeType = NodeType.T_LUR;
			if (neighbours[0] != null && neighbours[1] != null && neighbours[2] == null && neighbours[3] == null)
				return nodeType = NodeType.TURN_UP_RIGHT;
			if (neighbours[0] == null && neighbours[1] != null && neighbours[2] != null && neighbours[3] == null)
				return nodeType = NodeType.TURN_RIGHT_DOWN;
			if (neighbours[0] == null && neighbours[1] == null && neighbours[2] != null && neighbours[3] != null)
				return nodeType = NodeType.TURN_DOWN_LEFT;
			if (neighbours[0] != null && neighbours[1] == null && neighbours[2] == null && neighbours[3] != null)
				return nodeType = NodeType.TURN_LEFT_UP;
			if (neighbours[0] != null && neighbours[1] == null && neighbours[2] != null && neighbours[3] == null)
				return nodeType = NodeType.CORRIDOR_UP_DOWN;
			if (neighbours[0] == null && neighbours[1] != null && neighbours[2] == null && neighbours[3] != null)
				return nodeType = NodeType.CORRIDOR_LEFT_RIGHT;
			if (neighbours[0] == null && neighbours[1] == null && neighbours[2] == null && neighbours[3] == null)
				return nodeType = NodeType.SOLITER;
		...
		/**
		 * Array[UP, RIGHT, DOWN, LEFT] (as defined by {@link Direction#index}). Array
		 * may contain NULLs == wall.
		 * 
		 * @return
		 */
		 ...
		 * 
		 * Array[UP, RIGHT, DOWN, LEFT] (as defined by {@link Direction#index}). Array
		 * may contain NULLs == wall || forbidden node.
		 * 
		 * @return
		 */
		...
		/**
		 * Returns a {@link MazeNode} in given 'direction' or NULL if there is a wall.
		 * {@link Direction#NONE} evaluates to 'this'.
		 * 
		 * @param direction
		 * @return
		 */
		...
		/**
		 * If there is walkable node in given 'direction'. {@link Direction#NONE}
		 * evaluates to 'null'.
		 * 
		 * @param direction
		 * @return
		...
		public MazeNode getRandomLink(MazeNode... forbidden) {
			...
			while (directions.size() > 0) {
				Direction dir = directions.remove(directions.size() - 1);
				if (options[dir.index] != null)
					return options[dir.index];
			}
			return null;
		}
		...
		public Direction direction(int neighbour) {
			for (Direction dir : Direction.arrows()) {
				MazeNode node = link(dir);
				if (node != null && node.index == neighbour)
					return dir;
			}
			return Direction.NONE;
		}
	...
	public Set<Integer> getGhostLocationIndices() {
		if (lastGhostTimeIndices == game.getTotalTime())
	...
	public MazeNode[] getGhostLocations() {
		if (lastGhostTimeLocations == game.getTotalTime())
	...
	public Set<MazeNode> getGhostLocationSet() {
		if (lastGhostTimeLocationSet == game.getTotalTime())
