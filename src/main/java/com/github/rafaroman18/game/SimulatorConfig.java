...
public class SimulatorConfig {
	...
	/**
	 * How long can PacMan / Ghost controller think about the game before we compute
	 * next frame. If {@ #visualize} than it also determines the speed of the game.
	 * 
	 * DEFAULT: 25 FPS
	 */
	...
	public String getCSV() {
		return game.getCSV() + ";" + thinkTimeMillis + ";" + visualize + ";" + visualizationScale2x + ";" + mayBePaused
	...
	public String getOptions() {
		return SimulatorConfigOption.GAME_LEVELS_TO_PLAY.option + " " + game.levelsToPlay + " "
				...
				+ SimulatorConfigOption.GAME_GHOST_COUNT.option + " "
				+ (ghostsController == null ? "N/A" : ghostsController.getGhostCount()) + " "
				+ SimulatorConfigOption.SIM_CAN_BE_PAUSED.option + " " + mayBePaused + " "
				+ SimulatorConfigOption.SIM_REPLAY.option + " " + replay
				+ (replayFile != null
						? " " + SimulatorConfigOption.SIM_REPLAY_FILE.option + " " + replayFile.getAbsolutePath()
						: "")
